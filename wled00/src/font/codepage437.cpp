...
uint16_t wchar16ToCodepage437(uint16_t wideChar) {
  ...
  switch (wideChar) {
    ...
    // Cyrillic fallback map (single-glyph transliteration for CP437 fonts)
    // This ensures Russian/Ukrainian/Bulgarian text remains readable even when only CP437 glyphs are available.
    case 0x0401: return 'E';   break; // Ё
    case 0x0451: return 'e';   break; // ё
    case 0x0410: return 'A';   break; // А
    case 0x0430: return 'a';   break; // а
    case 0x0411: return 'B';   break; // Б
    case 0x0431: return 'b';   break; // б
    case 0x0412: return 'B';   break; // В
    case 0x0432: return 'b';   break; // в
    case 0x0413: return 'r';   break; // Г
    case 0x0433: return 'r';   break; // г
    case 0x0414: return 'D';   break; // Д
    case 0x0434: return 'd';   break; // д
    ...
    case 0x041B: return 'L';   break; // Л
    case 0x043B: return 'l';   break; // л
    ...
    case 0x041F: return 'P';   break; // П
    case 0x043F: return 'p';   break; // п
    ...
    case 0x0424: return 0xE8;  break; // Ф -> Φ
    case 0x0444: return 0xED;  break; // ф -> φ
    ...
    case 0x042E: return 'U';   break; // Ю
    case 0x044E: return 'u';   break; // ю
    case 0x042F: return 'R';   break; // Я
    case 0x044F: return 'r';   break; // я
