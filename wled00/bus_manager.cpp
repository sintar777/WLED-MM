...
BusHub75Matrix::BusHub75Matrix(BusConfig &bc) : Bus(bc.type, bc.start, bc.autoWhite) {
  ...
  if (bc.type > 104 && bc.type != 109) mxconfig.driver = HUB75_I2S_CFG::FM6124;  // use FM6124 for "outdoor" panels - workaround until we can make the driver user-configurable
  if (bc.type == 109) mxconfig.driver = HUB75_I2S_CFG::ICN2038S;  // ICN2038S driver for 32x16 1/4 scan indoor panels
  ...
  switch(bc.type) {
    ...
    case 108: // untested
      ...
      mxconfig.mx_height = 64 / 2;
      break;
    case 109: // 32x16 ICN2038S 1/4 scan indoor panel
      mxconfig.mx_width = 32;
